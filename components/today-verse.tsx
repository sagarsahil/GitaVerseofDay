  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col">
      <header className="mb-8 flex flex-col items-center text-center sm:mb-10">
        ...
        <h1 className="font-heading mt-3 max-w-md text-3xl leading-tight text-balance text-foreground sm:text-4xl">
        ...
        <p className="mt-3 max-w-lg text-sm leading-relaxed text-muted-foreground sm:text-base">
          ...
          tomorrow for the next one in the collection.
        </p>
      </header>
      {children}
    </div>
...
function LoadedVerse({ verse, date }: { verse: GitaVerse; date: Date }) {
  ...
  return (
    <Card className="border-none bg-card/90 shadow-[0_24px_60px_-28px_oklch(0.35_0.06_50/0.45)] ring-1 ring-primary/12">
...
function VerseSkeleton() {
  return (
    <Card className="border-none bg-card/90 ring-1 ring-primary/12">
      <CardHeader className="gap-3">
